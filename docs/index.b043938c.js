...
var eB=Object.getOwnPropertyDescriptor;i=$?eB:function(e,t){if(e=H(e),t=Q(t),eW)try{return eB(e,t)}catch(e){}if(eF(e,t))return I(!F(o,e,t),e[t])};var eJ={},eY={};// V8 ~ Chrome 36-
...
tj=function(e,t){var r=t$(e);return r<0?tP(r+t,0):tx(r,t)};var tT={},tI={},tH=Math.min;// `ToLength` abstract operation
// https://tc39.es/ecma262/#sec-tolength
tI=function(e){return e>0?tH(t$(e),9007199254740991):0;// 2 ** 53 - 1 == 9007199254740991
},// `LengthOfArrayLike` abstract operation
// https://tc39.es/ecma262/#sec-lengthofarraylike
tT=function(e){return tI(e.length)};// `Array.prototype.{ indexOf, includes }` methods implementation
var tq=function(e){return function(t,r,n){var i,o=H(t),a=tT(o),s=tj(n,a);// Array#includes uses SameValueZero equality algorithm
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=rJ:Function("r","regeneratorRuntime = r")(rJ)}const rY=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rH.renderSpinner(),rD.update(rj()),rU.update(rk.bookmarks),// Load recipe
...
await rO(e),rD.render(rj()),rW.render(rk.search)}catch(e){console.error(e)}},rV=async function(e){try{rB.renderSpinner(),// Upload new recipe data
...
r$(e),rH.update(rk.recipe)}),rH.addHandlerAddBookmark(function(){rk.recipe.bookmarked?rM(rk.recipe.id):rF(rk.recipe),rH.update(rk.recipe),rU.render(rk.bookmarks)}),rN.addHandlerSearch(rQ),rW.addHandlerClick(function(e){rD.render(rj(e)),rW.render(rk.search)}),rB.addHandlerUpload(rV);//# sourceMappingURL=index.b043938c.js.map

//# sourceMappingURL=index.b043938c.js.map
